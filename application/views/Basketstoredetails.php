									...
									<div  class="done-btn">
										<div class="row">
											<div class="col-md-3 col-sm-3 col-xs-3">
												<button id="add-voice" type="button" class="btn fleft btn-card add-voice-btn">Add Voice</button>
											</div>
...
<div id="myNav" class="overlay">
  ...
  <div class="modal fade" id="addonDetailModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<script type="text/javascript" src="<?php echo base_url();?>assets/js/servelet.js"></script>
	<script src="<?php echo base_url();?>assets/js/recordmessage.js"></script>
	  <script src="<?php echo base_url();?>assets/js/recordmp3.js"></script>
